...
class WordLenHTML(Rule):
    def __init__(self, feature_dict):
        super().__init__(feature_dict, name="WordLenHTML")
        self.description = "the ratio of word count to char count in html"

    def analyze(self):
        info_dict = self.feature_dict["html"]["WordCountHTML"]
        res_dict = {}
        ...
        for filename, info in info_dict.items():
            ...
            html_char_count = self.feature_dict["html"]["CharCountHTML"][filename][
                "count"
            ]
